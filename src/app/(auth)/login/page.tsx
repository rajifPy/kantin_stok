  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-20 w-72 h-72 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000" />
        <div className="absolute -bottom-32 left-1/2 w-72 h-72 bg-pink-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000" />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <Sparkles className="absolute top-1/4 left-1/4 text-white/20 w-8 h-8 animate-float" />
        <ShoppingBag className="absolute top-1/3 right-1/3 text-white/20 w-10 h-10 animate-float animation-delay-1000" />
        <Sparkles className="absolute bottom-1/4 right-1/4 text-white/20 w-6 h-6 animate-float animation-delay-2000" />
      </div>
          ...
          <div className="backdrop-blur-2xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="relative p-8 text-center">
              ...
              <div className="relative inline-block mb-6 animate-bounce-in">
                ...
                <div className="relative w-24 h-24 bg-gradient-to-br from-white/30 to-white/10 backdrop-blur-sm rounded-full border border-white/30 flex items-center justify-center shadow-xl transform hover:scale-110 transition-transform duration-300">
                  <ShoppingBag className="text-white w-12 h-12 animate-float" />
                </div>
                {/* Floating Ring */}
                <div className="absolute inset-0 rounded-full border-2 border-white/20 animate-ping" />
              </div>
              
              <h1 className="text-4xl font-bold text-white mb-2 drop-shadow-lg animate-fade-in-down animation-delay-100">
                Kantin Sekolah
              </h1>
              <p className="text-white/80 text-lg animate-fade-in-down animation-delay-200">
            ...
            <div className="p-8 pt-0">
              ...
              {/* Demo Credentials */}
              <div className="mt-8 backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 animate-fade-in-up animation-delay-1000">
